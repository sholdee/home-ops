...
- Live physical-node Ansible orchestration lives under `hack/bootstrap/ansible/`. Treat `k3s-ansible` as the engine and keep site-specific inventory rendering, 1Password token handling, and live confirmation prompts in `home-ops`.
