...
@test "node reimage image source renders rpi-image-gen config and first-boot layer" {
  ...
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'conntrack'
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'cryptsetup'
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'dnsutils'
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'dmsetup'
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'e2fsprogs'
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'ethtool'
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'htop'
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'initramfs-tools'
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'kmod'
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'lsof'
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'nano'
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'nvme-cli'
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'smartmontools'
  assert_file_contains "${output_dir}/layer/home-ops-node-bootstrap.yaml" 'strace'
...
EOF
  ...
  run env PATH="${tmp}:${PATH}" NODE_LIVE_INVENTORY_DIR="$inventory" NODE_REIMAGE_OUTPUT_ROOT="${tmp}/reimage-out" \
    ...
    NODE_REIMAGE_PORT_DOWN_POLL_SECONDS=0 NODE_REIMAGE_PORT_UP_POLL_SECONDS=0 NODE_REIMAGE_PING_POLL_SECONDS=0 NODE_REIMAGE_SSH_AUTH_POLL_SECONDS=0 \
