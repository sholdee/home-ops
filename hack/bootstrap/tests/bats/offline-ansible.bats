...
@test "static Ansible lifecycle invariants are present" {
  ...
  assert_file_contains "$ROOT/.github/workflows/pull-image.yml" 'python3 .github/scripts/extract_image_info.py'
  assert_file_contains "$ROOT/.github/workflows/helm-diff.yml" 'python3 .github/scripts/extract_image_info.py'
  assert_file_not_contains "$ROOT/.github/workflows/pull-image.yml" 'python .github/scripts/extract_image_info.py'
  assert_file_not_contains "$ROOT/.github/workflows/helm-diff.yml" 'python .github/scripts/extract_image_info.py'
