...
@test "static Ansible lifecycle invariants are present" {
  ...
  assert_file_contains "$ROOT/hack/bootstrap/ansible/home-ops/templates/cilium-bootstrap-application.yaml.j2" "cilium_iface != 'auto'"
  assert_file_not_contains "$ROOT/hack/bootstrap/ansible/home-ops/templates/cilium-bootstrap-application.yaml.j2" 'cilium_hubble'
